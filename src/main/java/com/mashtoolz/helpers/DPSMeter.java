...
public class DPSMeter {
	...
	public ArrayList<String> damageNumbers = new ArrayList<>(Arrays.asList("０", "１", "２", "３", "４", "５", "６", "７", "８", "９"));
	...
	public Integer parseDamage(String text) {
		...
		Arrays.stream(text.split("")).filter(segment -> damageNumbers.contains(segment)).forEach(segment -> damage.append(segment));
